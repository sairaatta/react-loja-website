    ...
    <>
      ...
      <section className="relative w-full h-screen bg-gray-100">
        <div className="relative w-full h-full">
          <img src={cloth1} alt="Clothing" className="w-full h-full object-cover" />
          <button className="absolute bottom-10 left-1/2 transform -translate-x-1/2 bg-customTerracotta text-white px-12 py-3 rounded-lg hover:bg-opacity-90 transition duration-300">
            SHOP NOW
          </button>
        </div>
      </section>
